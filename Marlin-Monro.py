...
def draw_marlin():
    ...
    while lines <= 1:
        while rows <= n:
            ...
            # Face
            marlin.append(polygon([(115 * k + p, 89 * k + o), (108 * k + p, 77 * k + o), (108 * k + p, 70 * k + o),
                                   (103 * k + p, 58 * k + o), (104 * k + p, 25 * k + o), (149 * k + p, 20 * k + o),
                                   (150 * k + p, 55 * k + o), (141 * k + p, 69 * k + o), (143 * k + p, 77 * k + o),
                                   (129 * k + p, 90 * k + o), (115 * k + p, 89 * k + o)]))

            # Lips
            marlin.append(polygon([(113 * k + p, 74 * k + o), (118 * k + p, 71 * k + o), (128 * k + p, 71 * k + o),
                                   (131 * k + p, 74 * k + o), (124 * k + p, 80 * k + o), (117 * k + p, 80 * k + o),
                                   (113 * k + p, 74 * k + o)]))

            # Eye
            marlin.append(polyline([(130 * k + p, 52 * k + o), (134 * k + p, 51 * k + o), (139 * k + p, 53 * k + o)]))
            marlin.append(polyline([(114 * k + p, 52 * k + o), (107 * k + p, 52 * k + o), (107 * k + p, 55 * k + o)]))
            marlin.append(polyline([(118 * k + p, 64 * k + o), (121 * k + p, 66 * k + o), (124 * k + p, 65 * k + o),
                                    (128 * k + p, 65 * k + o)]))
            marlin.append(polyline([(130 * k + p, 44 * k + o), (139 * k + p, 42 * k + o), (146 * k + p, 48 * k + o)]))
            marlin.append(polyline([(114 * k + p, 45 * k + o), (107 * k + p, 43 * k + o), (103 * k + p, 46 * k + o)]))

            # Brows
            marlin.append(polygon([(126 * k + p, 51 * k + o), (129 * k + p, 48 * k + o), (133 * k + p, 46 * k + o),
                                   (141 * k + p, 50 * k + o), (134 * k + p, 50 * k + o), (128 * k + p, 50 * k + o)]))
            ...
            # Hair
            marlin.append(polygon([(121 * k + p, 27 * k + o), (138 * k + p, 22 * k + o), (146 * k + p, 25 * k + o),
